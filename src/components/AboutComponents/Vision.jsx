const Vision = () => {
    return (
        <section className="p-32 flex flex-col gap-20">
            <div className="grid grid-cols-2 justify-items-center">
                <div>
                    <h1 className="text-3xl font-bold text-blue-500">Our Vision</h1>
            ...
            <div className="grid grid-cols-2 justify-items-center">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-blue-500">What Makes us Different</h1>
            ...
            <div className="grid grid-cols-2 justify-items-center">
                <div>
                    <h1 className="text-3xl font-bold text-blue-500">Offerings</h1>
