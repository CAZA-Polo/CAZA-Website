...
const CookiePolicy = () => {
    return (
        ...
        <main className="md:p-24 md:pt-16 p-16 bg-gray-100 container mx-auto">
            <div>
            ...
            <div className="flex flex-col gap-5">
                <div className="text-sky-950 font-medium">
                    <p className="text-lg text-sky-950 font-normal">CAZA Technology Solutions Inc. ("CAZA") is committed to safeguarding your personal information, and we wish to be transparent about how we handle the same.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-normal">Accordingly, we developed this Cookie Notice to inform you about our use of cookies across this website. We want you to understand what cookies are, how CAZA uses cookies, and what your choices are.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-normal">A cookie is a small piece of data (text file) that a website - when visited by a user - asks your browser to store on your device in order to remember information about you, such as your language preference or login information. 
                    ...
                    <ul className="list-disc ml-10 mt-5">
                        <li className="text-lg text-sky-950 font-normal"><b>Strictly Necessary Cookies.</b> These cookies are necessary for the website to function and cannot be switched off in our systems. CAZA embeds cookies that are essential for navigating and enabling functionalities such as local device authentication, animation, and image caching. These cookies are turned on by default. If you set your browser to block these cookies, some parts of the site will not work.</li>
                        <li className="text-lg text-sky-950 font-normal"><b>Performance Cookies.</b>CAZA uses cookies to understand how visitors use the website and its services in order to improve the over-all performance. Performance cookies provide insights into trends and usage patterns that are used for business analysis, website and service improvements, and for determining performance metrics.</li>
                    </ul>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-normal">The use of cookies also depends on the settings of the web browser you are using (e.g., Microsoft Edge, Google Chrome, Apple Safari, Mozilla Firefox). Most web browsers are preset to automatically accept certain types of cookies.  However, you can usually change this setting. You can delete stored cookies at any time. Web/DOM storage and local shared objects can be deleted separately. You can find out how this works in the browser or device you are using in the manual of the learner.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-normal">The consent to, and rejection or deletion of, cookies are tied to the device and also to the respective web browser you use. If you use multiple devices or web browsers, you can make decisions or settings differently.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-normal">If you choose to delete or refuse to accept cookies, you may not have access to some or all functions of our website or individual functions may be limited.</p>
                </div>

                <div>
                    <h2 className="text-lg text-sky-950 font-medium"><b>WEBSITE, COOKIES & SIMILAR TECHNOLOGIES TRACKING POLICY</b></h2>
