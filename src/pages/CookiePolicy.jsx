    ...
    return (
        ...
        <main className="md:p-24 md:pt-16 p-16 bg-gray-100 container mx-auto">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div>
                    <p className="text-lg text-sky-950 font-medium">Accordingly, we developed this Cookie Notice to inform you about our use of cookies across this website. We want you to understand what cookies are, how CAZA uses cookies, and what your choices are.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-medium">A cookie is a small piece of data (text file) that a website - when visited by a user - asks your browser to store on your device in order to remember information about you, such as your language preference or login information. 
                ...
                <div>
                    <p className="text-lg text-sky-950 font-medium">The use of cookies also depends on the settings of the web browser you are using (e.g., Microsoft Edge, Google Chrome, Apple Safari, Mozilla Firefox). Most web browsers are preset to automatically accept certain types of cookies.  However, you can usually change this setting. You can delete stored cookies at any time. Web/DOM storage and local shared objects can be deleted separately. You can find out how this works in the browser or device you are using in the manual of the learner.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-medium">The consent to, and rejection or deletion of, cookies are tied to the device and also to the respective web browser you use. If you use multiple devices or web browsers, you can make decisions or settings differently.</p>
                </div>

                <div>
                    <p className="text-lg text-sky-950 font-medium">If you choose to delete or refuse to accept cookies, you may not have access to some or all functions of our website or individual functions may be limited.</p>
                </div>
