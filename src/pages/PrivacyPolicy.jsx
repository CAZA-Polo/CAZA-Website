    ...
    return (
        ...
        <main className="md:p-24 p-8 bg-gray-100 list-outside text-justify">   
            ...
            <hr className="h-px md:my-8 my-3 bg-gray-200 border-0 dark:bg-sky-500"></hr>
                ...
                <h2 className="md:mt-24 mt-12 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Background</h2>
                ...
                <h1 className="md:mt-14 mt-10 md:text-3xl text-xl text-sky-950 font-semibold upper-roman"> Introduction</h1>
                <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                ...
                <h1 className="md:mt-14 mt-10 md:text-3xl text-xl text-sky-950 font-semibold upper-roman"> Definition</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                <ul className="md:text-lg text-sm text-sky-950 font-bold md:mt-8 mt-6 space-y-5 list-inside">
                    <li className=""> “Act” refers to Republic Act No. 10173, also known as the Data Privacy Act of 2012;
                    </li>
                    <li className="">“Commission” refers to the National Privacy Commission;
                    </li>
                    ...
                    <li className="">“Personal data” refers to all types of personal information;
                    </li>
                ...
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman"> Scope</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                ...
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Processing of Personal Data</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                    <p className="md:mt-7 mt-5 md:text-lg text-sm text-sky-950 font-medium"><b> A. Collection</b></p>

                <ul className="md:text-lg text-sm text-sky-950 font-bold md:mt-8 mt-6 space-y-5 list-inside">                    <li className="indent-10"> CAZA collects the basic contact information of clients and customers, including their full name,
                ...
                <ul className="md:text-lg text-sm text-sky-950 font-bold md:mt-8 mt-6 space-y-5 list-inside">
                    ...
                    <p className="md:mt-7 mt-5 md:text-lg text-sm text-sky-950 font-medium"><b> C. Storage, Retention, and Destruction</b></p>
                ...
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Security Measures</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                ...
                <ul className="md:text-lg text-sm text-sky-950 font-bold md:mt-8 mt-6 space-y-5 list-inside">
                    ...
                    <p className="md:mt-7 mt-5 md:text-lg text-sm text-sky-950 font-medium"><b> B. Physical Security Measures</b></p>
                <ul className="md:text-lg text-sm text-sky-950 font-bold md:mt-8 mt-6 space-y-5 list-inside">
                ...
                <ul> 
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Breach and Security Incidents</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul> 
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Complaints/Requests</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul> 
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Effectivity</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul> 
                <h1 className="md:mt-14 mt-8 md:text-3xl text-xl text-sky-950 font-semibold upper-roman">Annexes</h1>
                        <hr className="md:w-16 w-10 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
