            ...
            <hr className="h-px my-8 bg-gray-200 border-0 dark:bg-sky-500"></hr>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> Republic Act No. 10173, also known as the Data Privacy Act of 2012 (DPA), aims to protect personal
                        data in information and communications systems both in the government and the private sector.</li>
                    ...
                    <li className="indent-10">It ensures that entities or organizations processing personal data establish policies, and implement
                        ...
                        access, fraudulent misuse, unlawful destruction, alteration and contamination.</li>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> This Privacy Manual is hereby adopted in compliance with Republic Act No. 10173 or the Data
                        ...
                        issuances of the National Privacy Commission.</li>
                    ...
                    <li className="indent-10">CAZA respects and values your data privacy rights, and makes sure that all personal data collected
                        ...
                        legitimate purpose, and proportionality.</li>

                    <li className="indent-10">This Privacy Manual shall inform you of our data protection and security measures, and may serve
                        as your guide in exercising your rights under the DPA.</li>
                </ul>
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold upper-roman"> Definition</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-none list-inside">
                    ...
                    <li className="">“Data processing systems” refers to the structure and procedure by which personal data is collected and 
                        ...
                        purpose and intended output of the processing;</li>
                    ...
                    <li className="">“Personal information” refers to any information, whether recorded in a material form or not, from which the
                        ...
                        information, or when put together with other information would directly and certainly identify an individual;</li>

                    <li className="">“Personal information controller” refers to a natural or juridical person, or any other body who controls the
                        processing of personal data, or instructs another to process personal data on its behalf. The term excludes:</li>
                ...
                <ul>
                    ...
                    <li className="">“Processing” refers to any operation or any set of operations performed upon personal data including, but
                        ...
                        contained in a filing system;</li>
                    ...
                    <li className="">“Security incident” is an event or occurrence that affects or tends to affect data protection, or may
                        ...
                        result to a personal data breach, if not for safeguards that have been put in place;</li>
                 ...
                 <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-decimal list-outside ml-10">
                    ...
                    <li>About an individual’s health, education, genetic or sexual life of a person, or to any proceeding
                        ...
                        such proceedings, or the sentence of any court in such proceedings;</li>
                    <li>Issued by government agencies peculiar to an individual which includes, but is not limited to,
                        ...
                        revocation, and tax returns; and</li>
                    <li>Specifically established by an executive order or an act of Congress to be kept classified.</li>
                </ul>

                </ul>
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold upper-roman">Scope</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> All employees and personnel of CAZA, regardless of the type of employment or contractual
                        arrangement, must comply with the terms set out in this Privacy Manual.</li>
                </ul>

                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Processing of Personal Data</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                    <p className="mt-7 text-lg text-sky-950 font-medium"><b> A. Collection</b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> CAZA collects the basic contact information of clients and customers, including their full name,
                        ...
                        referred as “Services”), do not collect any data with regard to the clients of the customers.</li>
                </ul>

                    <p className="mt-10 text-lg text-sky-950 font-medium"><b> B. Use</b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> The personal data collected shall be used by CAZA for documentation purposes, for
                        ...
                        of CAZA in order to implement the Services.</li>
                </ul>

                    <p className="mt-10 text-lg text-sky-950 font-medium"><b> C. Storage, Retention, and Destruction</b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> CAZA ensures that personal data under its custody are protected against any accidental or unlawful
                        ...
                        through secured means.</li>
                </ul>

                    <p className="mt-10 text-lg text-sky-950 font-medium"><b> D. Access</b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> Due to the sensitive and confidential nature of the personal data under the custody of the company,
                        ...
                        data, for any purpose, except for those contrary to law, public policy, public order or morals.</li>
                </ul>

                    <p className="mt-10 text-lg text-sky-950 font-medium"><b> E. Disclosure and Sharing </b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> All employees and personnel of CAZA shall maintain the confidentiality and secrecy of all personal
                        ...
                        purpose, and to authorized recipients of such data.</li>
                </ul>
                
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Security Measures</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>

                    <p className="mt-7 text-lg text-sky-950 font-medium"><b> A. Organization Security Measures</b></p>

                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-outside">
                    <li className="indent-10"> CAZA shall implement reasonable and appropriate physical, technical and organizational
                        ...
                        alteration and contamination.</li>
                ...
                <ul>
                    <li className="indent-10"> CAZA shall sponsor a mandatory training on data privacy and security at least once a year. For
                        ...
                        and participation in relevant trainings and orientations, as often as necessary.</li>
                    ...
                    <li className="indent-10"> All employees, staff, personnel and service providers (hereafter referred as “employees”) will be
                        ...
                        and hold personal data under strict confidentiality if the same is not intended for public disclosure.</li>
                    <li className="indent-10"> This Manual shall be reviewed and evaluated annually. Privacy and security policies and practices
                        within CAZA shall be updated to remain consistent with current data privacy best practices.</li>
                </ul>

                    <p className="mt-7 text-lg text-sky-950 font-medium"><b> B. Physical Security Measures</b></p>
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> CAZA shall strictly follow the procedures intended to monitor and limit access to the facility
                        ...
                        measures adopted by CAZA are:</li>
                </ul>
                 ...
                 <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-decimal list-outside ml-10">
                    ...
                    <li>Only authorized personnel shall be allowed inside the data room. For this purpose, they shall each be given a duplicate of the key to the room. Other personnel may be granted access to
                        the room upon filing of an access request form with the Data Protection Officer and the latter’s approval thereof.</li>
                    <li>All employees of CAZA shall comply with the Clean Desk Policy such that every time a
                        ...
                        drawers under lock and key, and secure all documents or devices containing personal data. </li>
                    <li>Employees authorized to enter and access the data room or facility must fill out and register
                        ...
                        shall indicate the date, time, duration and purpose of each access. </li>
                    <li>The computers are positioned with considerable spaces between them to maintain privacy
                        ...
                        designate officer for safekeeping.</li>
                    <li> Persons involved in processing shall always maintain confidentiality and integrity of
                        ...
                        entering the data storage room.</li>
                    ...
                    <li> CAZA shall retain the personal data of a client for one (1) year from the data of purchase. Upon expiration of such period, all physical and electronic copies of the personal data shall be
                        destroyed and disposed of using secure technology. </li>    
                </ul>

                    <p className="mt-7 text-lg text-sky-950 font-medium"><b> C. Technical Security Measures</b></p>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-decimal list-outside ml-10">
                    <li>CAZA shall use an intrusion detection system to monitor security breaches and alert CAZA
                        of any attempt to interrupt or disturb the system.</li>
                    <li>CAZA shall first review and evaluate software applications before the installation thereof in
                        computers and devices of CAZA to ensure the compatibility of security features with overall operations.</li>
                    <li>Process for regularly testing, assessment and evaluation of effectiveness of security
                        ...
                        testing within the company on regular schedule to be prescribed by the appropriate department or unit. </li>
                    <li>CAZA uses encryption, authentication process, and other technical security measures that
                        ...
                        his or her identity using a secure encrypted link and multi-level authentication.</li>  
                </ul>  

                <ul> 
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Breach and Security Incidents</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul> 
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Complaints/Requests</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-5 list-inside">
                    <li className="indent-10"> Data subjects may inquire or request for information regarding any matter relating to the processing
                        ...
                        and provide contact details for reference. </li>
                </ul>

                <ul className="text-lg text-sky-950 font-bold mt-5 space-y-5 list-none list-outside ml-10">
                    <li>Written inquiries / requests / complaints may be sent to:</li>
                </ul>

                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-0 list-none list-outside ml-10">
                ...
                <ul> 
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Effectivity</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>
                ...
                <ul> 
                <h1 className="mt-14 text-3xl text-sky-950 font-semibold">Annexes</h1>
                        <hr className="w-16 h-1 my-1 bg-gray-100 border-0 rounded md:my-1 dark:bg-sky-500"></hr>
                </ul>

                <ul className="text-lg text-sky-950 font-bold mt-5 space-y-5 list-none list-outside ml-10">
                    <li>Attached to this Privacy Manual are the following: </li>
                </ul>

                <ul className="text-lg text-sky-950 font-bold mt-8 space-y-0 list-decimal list-outside ml-10">
                    <li>Consent Form</li>
                    <li>Inquiry Form</li>
